...
docker run -d --rm --privileged --name lldb_server -p 9293:9293 -p 9294:9294 -p 9295:9295 -p 9296:9296 -v /tmp:/debug --volumes-from swift_runtime  cscix65g/lldb-server:amd64-latest
